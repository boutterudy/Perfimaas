...
export declare class UsersController {
    ...
    createBankAccounts(id: string, newBankAccount: CreateBankAccountDto): BankAccount[] | NotFoundException;
    updateBankAccounts(id: string, bankAccountId: string, updatedBankAccount: UpdateBankAccountDto): BankAccount | NotFoundException;
    ...
    createGoal(id: string, newGoal: CreateGoalDto): Goal[] | NotFoundException;
    updateGoal(id: string, goalId: string, updatedGoal: UpdateGoalDto): Goal | NotFoundException;
    ...
    createSurplusCashFlowManagement(id: string, newCashFlowDistribution: CreateCashFlowDistributionDto): CashFlowDistribution[] | NotFoundException;
    updateSurplusCashFlowManagement(id: string, cashFlowDistributionId: string, updatedCashFlowDistribution: UpdateCashFlowDistributionDto): CashFlowDistribution | NotFoundException;
    ...
    createUnexpectedCashFlowManagement(id: string, newCashFlowDistribution: CreateCashFlowDistributionDto): CashFlowDistribution[] | NotFoundException;
